...
$output = Randomization::getAllocFileContents($_GET['status']);

// Logging
$statusText = ($_GET['status'] == '1') ? "production" : "development";
Logging::logEvent("", "redcap_randomization", "MANAGE", PROJECT_ID, "project_id = " . PROJECT_ID, "Download randomization allocation table ($statusText)");
