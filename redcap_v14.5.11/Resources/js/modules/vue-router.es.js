...
var VueRouter = function (exports, vue) {
  ...
  function scrollToPosition(position) {
    ...
    window.scrollTo(scrollToOptions);else
    {
      ...
      switch (state) {
        ...
        case 2 /* ParamRegExp */:
          ...
          if (char === ')') {
            ...
            customRe = customRe.slice(0, -1) + char;else
    ...
    constructor(plugin, hook) {
      ...
      this.proxiedTarget = new Proxy({}, {
        get: (_target, prop) => {
          ...
          if (Object.keys(this.fallbacks).includes(prop)) {
            return (...args) => {
  ...
  function createRouter(options) {
    ...
    function resolve(rawLocation, currentLocation) {
      ...
      if (typeof rawLocation === 'string') {
        ...
        {
          if (href.startsWith('//'))
          warn(`Location "${rawLocation}" resolved to "${href}". A resolved location cannot start with multiple slashes.`);else
  ...
  function extractChangingRecords(to, from) {
    ...
    for (let i = 0; i < len; i++) {
      ...
      if (recordFrom) {
        ...
        updatingRecords.push(recordFrom);else
