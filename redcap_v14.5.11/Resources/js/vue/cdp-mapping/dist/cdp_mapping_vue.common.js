...
__webpack_require__.d(__webpack_exports__, {
  "v": function() { return /* reexport */ Mapping; }
});

// UNUSED EXPORTS: MappingValidator
...
;// CONCATENATED MODULE: ./src/models/MappingValidator.js
...
class MappingValidator {
  ...
  addError(message) {
    _classPrivateFieldGet(this, _errors).push(message);
  }
  validate(mapping) {
  ...
  get rules() {
    return {
      ...
      isMappingEventInProject: mapping => {
        const {
          events
        } = this.store.state.app_settings.project;
...
;// CONCATENATED MODULE: ./src/models/Mapping.js
...
var _original_config = /*#__PURE__*/new WeakMap();
var _config = /*#__PURE__*/new WeakMap();
var _status = /*#__PURE__*/new WeakMap();
var _mappingValidator = /*#__PURE__*/new WeakMap();
var _validation_errors = /*#__PURE__*/new WeakMap();
class Mapping {
  /**
   * 
   * @param {*} config {
  ...
  constructor(store, id, config = {}) {
    ...
    _classPrivateFieldInitSpec(this, _original_config, {
      writable: true,
      value: void 0
    });
    ...
    _classPrivateFieldInitSpec(this, _mappingValidator, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldInitSpec(this, _validation_errors, {
      writable: true,
      value: []
    });
    this.store = store;
    _classPrivateFieldSet(this, _id, id);
    _classPrivateFieldSet(this, _original_config, {
      ...config
    });
  ...
  initConfigurationValidationProxy(config) {
    _classPrivateFieldSet(this, _mappingValidator, new MappingValidator(this.store));
    const configHandler = {
      set: (target, prop, value) => {
        target[prop] = value;
        _classPrivateFieldGet(this, _mappingValidator).validate(this);
        _classPrivateFieldSet(this, _validation_errors, _classPrivateFieldGet(this, _mappingValidator).errors);
        return true;
      }
    };
    _classPrivateFieldSet(this, _config, new Proxy({
      ...config
    }, configHandler));
    _classPrivateFieldSet(this, _validation_errors, _classPrivateFieldGet(this, _mappingValidator).validate(this));
  }
  get map_id() {
    const map_id = _classPrivateFieldGet(this, _config).map_id || null;
    return map_id;
  }
  get project_id() {
    const project_id = _classPrivateFieldGet(this, _config).project_id || null;
    return project_id;
  }
  get category() {
  ...
  get event_id() {
    return _classPrivateFieldGet(this, _config).event_id;
  }
  set event_id(value) {
    _classPrivateFieldGet(this, _config).event_id = value;
  }
  get field_name() {
    return _classPrivateFieldGet(this, _config).field_name;
  }
  set field_name(value) {
    _classPrivateFieldGet(this, _config).field_name = value;
  }
  get temporal_field() {
    return _classPrivateFieldGet(this, _config).temporal_field;
  }
  set temporal_field(value) {
    _classPrivateFieldGet(this, _config).temporal_field = value;
  }
  get preselect() {
    return _classPrivateFieldGet(this, _config).preselect;
  }
  set preselect(value) {
    _classPrivateFieldGet(this, _config).preselect = value;
  }
  get external_source_field_name() {
    return _classPrivateFieldGet(this, _config).external_source_field_name;
  }
  set external_source_field_name(value) {
    _classPrivateFieldGet(this, _config).external_source_field_name = value;
  }
  get fhir_data() {
    let fhir_field_key = _classPrivateFieldGet(this, _config).external_source_field_name || '';
   ...
   */
  get status() {
    return _classPrivateFieldGet(this, _status) || 'normal';
  }
  set status(value) {
    const status_list = ['normal', 'new', 'deleted'];
    if (status_list.indexOf(value) < 0) value = 'normal';
    _classPrivateFieldSet(this, _status, value);
  }
   ...
   */
  getConfig(name) {
    return _classPrivateFieldGet(this, _config)[name];
  }
  ...
  setConfig(name, value) {
    _classPrivateFieldGet(this, _config)[name] = value;
  }
  ...
  get validation_errors() {
    return [..._classPrivateFieldGet(this, _validation_errors)];
  }
  get has_errors() {
    return this.validation_errors.length > 0;
  }
  get dirty() {
    for (let [key, value] of Object.entries(_classPrivateFieldGet(this, _original_config))) {
      if (_classPrivateFieldGet(this, _config)[key] != value) return true;
    }
    return false;
  }
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#app[data-v-1a0f4853]{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;max-width:800px}#app[data-v-1a0f4853] .alert{border-color:rgba(0,0,0,.1)!important}#app[data-v-1a0f4853] .alert.alert-warning{border-color:#ffeeba!important}", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".non-blank-space{content:\"\\u001E\";display:inline-block}", ""]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
var update = add("24223351", content, true, {"sourceMap":false,"shadowMode":false});
...
// add the styles to the DOM
var add = (__webpack_require__(4402)/* ["default"] */ .Z)
var update = add("7f49c078", content, true, {"sourceMap":false,"shadowMode":false});
...
/******/ 			return "cdp_mapping_vue.common." + chunkId + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 	!function() {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "cdp-mapping:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = (typeof self !== 'undefined' ? self : this)["webpackChunkcdp_mapping"] = (typeof self !== 'undefined' ? self : this)["webpackChunkcdp_mapping"] || [];
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/App.vue?vue&type=template&id=1a0f4853&scoped=true&
var render = function render() {
  ...
  return _c('div', {
    ...
    attrs: {
      "show": _vm.status !== _vm.status_list.STATUS_READY,
      "rounded": "sm",
      "opacity": .90,
      "blur": "5px"
    }
  }, [_c('router-view'), _vm._v(" " + _vm._s(_vm.test) + " ")], 1), _vm.status == _vm.status_list.STATUS_ERROR ? _c('div', [_c('pre', [_vm._v(_vm._s(_vm.error))])]) : _vm._e()], 1);
};
var staticRenderFns = [];

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array.push.js
var es_array_push = __webpack_require__(7658);
;// CONCATENATED MODULE: ./src/libs/Utility.js
/**
 ...
 */
const getProperty = (subject, property_name) => {
  try {
 ...
 * @param {Int} index
 */
const compareWithRules = (rules, index = 0) => (a, b) => {
...
;// CONCATENATED MODULE: ./src/store/modules/app_settings.js
...
const initialState = {
  ...
  // list of temporal fields available in the project
  fhir_fields: {},
  // FHIR source fields as stored in the CSV file
  mapping: [],
  // mapping as stored in the database
  fhir_source_name: '',
  // name of the FHIR provider
  day_offset_min: 0,
  day_offset_max: 0,
  mapping_helper_url: ''
};
const app_settings_module = {
  namespaced: true,
  state: {
    ...initialState
  },
  ...
  getters: {
    ...
    previewFields: state => {
      ...
      let list = [...fhir_fields].filter(field => {
        return !(field.identifier || field.temporal);
      });
    ...
    groupedProjectTemporalFields: state => {
      const {
        project_temporal_fields: fields = {}
      } = state;
      return groupFieldsByFormName({
        ...fields
      });
    },
    ...
    getForms: state => event_id => {
      ...
      const grouped_fields = groupFieldsByFormName({
        ...fields
      });
      const {
        events_forms
    ...
    getPreselectOptions: state => {
      ...
      const options = [{
        ...
        value: 'MIN',
        label: translations['preselect_lowest'] || "Lowest numerical value"
      }, {
        value: 'MAX',
        label: translations['preselect_highest'] || "Highest numerical value"
      }, {
        value: 'FIRST',
        label: translations['preselect_earliest'] || "Earliest value (based on timestamp)"
      }, {
        value: 'LAST',
        label: translations['preselect_latest'] || "Latest value (based on timestamp)"
      }, {
        value: 'NEAR',
        label: translations['preselect_nearest'] || "Nearest value (based on timestamp)"
      }];
      return options;
    },
    /**
...
/* harmony default export */ var app_settings = (app_settings_module);
;// CONCATENATED MODULE: ./src/store/modules/fhir_fields_select.js

const fhir_fields_select_initialState = {
  selected: [],
  // fields always selected
  filter: '',
  // filter for fields
  fields: []
};
const fhir_fields_select_module = {
  namespaced: true,
  state: {
    ...fhir_fields_select_initialState
  },
  mutations: {
  ...
  actions: {
    ...
    setFields(context, params) {
      context.commit('SET_FIELDS', params);
    },
...
/* harmony default export */ var fhir_fields_select = (fhir_fields_select_module);
// EXTERNAL MODULE: ./src/models/index.js + 9 modules
var models = __webpack_require__(5437);
;// CONCATENATED MODULE: ./src/store/modules/mapping.js
...
const mapping_initialState = {
  list: [],
  // list of mappings
  auto_id: 1 // auto incremental primary key for the table rows
};

const mapping_module = {
  namespaced: true,
  state: {
    ...mapping_initialState
  },
  mutations: {
  ...
  actions: {
    ...
    async mappingFactory(context, config = {}) {
      ...
      const item = new models/* Mapping */.v(this, id, config);
      return item;
    },
    /**
  ...
  getters: {
    ...
    previewFields: state => {
      const list = [...state.list].filter(mapping => {
        return !(mapping.is_identifier || mapping.is_temporal);
      });
      return list;
    },
    /**
...
/* harmony default export */ var mapping = (mapping_module);
...
/* harmony default export */ var settings = (settings_module);
 ...
 * state management
 */
/* harmony default export */ var store = ((context, Vuex) => {
  var initialState = {};
  const store = new Vuex.Store({
    ...
    modules: {
      ...
      settings: settings,
      mapping: mapping,
      fhir_fields_select: fhir_fields_select
    },
    mutations: {},
    actions: {},
    getters: {}
...
const routes = [{
  path: '/',
  component: () => __webpack_require__.e(/* import() */ 91).then(__webpack_require__.bind(__webpack_require__, 1091)),
  children: [{
    path: '',
    name: 'home',
    component: () => Promise.all(/* import() */[__webpack_require__.e(625), __webpack_require__.e(345)]).then(__webpack_require__.bind(__webpack_require__, 3345))
  },
  // { path: 'fhir_fields', name: 'fhir_fields', component: () => import('@/pages/FhirFields') },
  {
    path: 'test',
    name: 'test',
    component: () => Promise.all(/* import() */[__webpack_require__.e(980), __webpack_require__.e(121)]).then(__webpack_require__.bind(__webpack_require__, 4121))
  }, {
    path: "*",
    name: 'not_found',
    component: () => __webpack_require__.e(/* import() */ 656).then(__webpack_require__.bind(__webpack_require__, 8115))
  }]
}];
/* harmony default export */ var router_routes = (routes);
;// CONCATENATED MODULE: ./src/router/index.js

/* harmony default export */ var router = ((context, VueRouter) => {
...
;// CONCATENATED MODULE: ./src/API/modules/settings.js
...
/* harmony default export */ var API = ((context, API) => {
  const api = new API({
    modules: {
...
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/NonBlankSpace.vue?vue&type=template&id=50384db0&
var NonBlankSpacevue_type_template_id_50384db0_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('span', {
    staticClass: "non-blank-space"
  });
};
var NonBlankSpacevue_type_template_id_50384db0_staticRenderFns = [];

;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/NonBlankSpace.vue?vue&type=script&lang=js&
/* harmony default export */ var NonBlankSpacevue_type_script_lang_js_ = ({});
;// CONCATENATED MODULE: ./src/components/NonBlankSpace.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_NonBlankSpacevue_type_script_lang_js_ = (NonBlankSpacevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-style-loader/index.js??clonedRuleSet-12.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/NonBlankSpace.vue?vue&type=style&index=0&id=50384db0&prod&lang=css&
var NonBlankSpacevue_type_style_index_0_id_50384db0_prod_lang_css_ = __webpack_require__(4478);
;// CONCATENATED MODULE: ./src/components/NonBlankSpace.vue?vue&type=style&index=0&id=50384db0&prod&lang=css&

// EXTERNAL MODULE: ./node_modules/@vue/vue-loader-v15/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1001);
;// CONCATENATED MODULE: ./src/components/NonBlankSpace.vue
...
var component = (0,componentNormalizer/* default */.Z)(
  components_NonBlankSpacevue_type_script_lang_js_,
  NonBlankSpacevue_type_template_id_50384db0_render,
  NonBlankSpacevue_type_template_id_50384db0_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var NonBlankSpace = (component.exports);
...
// EXTERNAL MODULE: ./node_modules/vue-style-loader/index.js??clonedRuleSet-12.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/App.vue?vue&type=style&index=0&id=1a0f4853&prod&scoped=true&lang=css&
var Appvue_type_style_index_0_id_1a0f4853_prod_scoped_true_lang_css_ = __webpack_require__(234);
;// CONCATENATED MODULE: ./src/App.vue?vue&type=style&index=0&id=1a0f4853&prod&scoped=true&lang=css&
