...
const form = computed({
    get: () => appStore.newConfig,
    set: (value) => (appStore.newConfig = value),
})
const breakTheGlassUserTypes = computed(() => appStore.breakTheGlassUserTypes)
const isDirty = computed(() => appStore.isDirty)
