<template>
    ...
    <b-modal ref="newSystemModal" size="xl">
        <template #header>New FHIR System</template>
...
import { useFhirSystemStore, useStore, useAppStore } from '../store'
...
const loading = computed(() => fhirSystemStore.loading)
const redirectURL = computed(() => appStore.redirectURL)
const systemForm = computed(() => fhirSystemStore.form)
const savePending = computed(() => store.savePending)
const currentSystem = computed(() => fhirSystemStore.current)
