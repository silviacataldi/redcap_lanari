((typeof self !== 'undefined' ? self : this)["webpackJsonpfhir_stats_vue"] = (typeof self !== 'undefined' ? self : this)["webpackJsonpfhir_stats_vue"] || []).push([[1],{
...
__webpack_require__.d(__webpack_exports__, "b", function() { return /* binding */ registerables; });
...
var plugin_tooltip = {
  ...
  afterInit(chart, _args, options) {
    if (options) {
      chart.tooltip = new chart_esm_Tooltip({_chart: chart, options});
    }
  },
  beforeUpdate(chart, _args, options) {
    if (chart.tooltip) {
