        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_intendedUseDescription-<?php echo $eventId;?>" type="text" value="<?php echo $intendedUseDescription;?>" class="x-form-text x-form-field" style="width:80%;">
                    <div class="newdbsub">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <div>
                        <input type="radio" name="extendedConfig_bodyPart-<?php echo $eventId;?>" <?php echo $kneeChecked;?> id="knee-<?php echo $eventId;?>" value="<?php echo ActiveTasks\RangeOfMotion::BODY_PART_KNEE; ?>">
                        <label for="knee-<?php echo $eventId;?>"><?php print RCView::tt('mycap_mobile_app_198');?></label>
                    </div>
                    <div style="margin:4px 0;">
                        <input type="radio" name="extendedConfig_bodyPart-<?php echo $eventId;?>" <?php echo $shoulderChecked;?> id="shoulder-<?php echo $eventId;?>" value="<?php echo ActiveTasks\RangeOfMotion::BODY_PART_SHOULDER; ?>">
                        <label for="shoulder-<?php echo $eventId;?>"><?php print RCView::tt('mycap_mobile_app_199');?></label>
                    </div>
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <div>
                        <input type="radio" name="extendedConfig_limbOption-<?php echo $eventId;?>" <?php echo $leftChecked;?> id="left-<?php echo $eventId;?>" value="<?php echo ActiveTasks\RangeOfMotion::LIMB_OPTION_LEFT; ?>">
                        <label for="left-<?php echo $eventId;?>"><?php print RCView::tt('mycap_mobile_app_200');?></label>
                    </div>
                    <div style="margin:4px 0;">
                        <input type="radio" name="extendedConfig_limbOption-<?php echo $eventId;?>" <?php echo $rightChecked;?> id="right-<?php echo $eventId;?>" value="<?php echo ActiveTasks\RangeOfMotion::LIMB_OPTION_RIGHT; ?>">
                        <label for="right-<?php echo $eventId;?>"><?php print RCView::tt('mycap_mobile_app_201');?></label>
                    </div>
    ...
    ?>
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_numberOfStepsPerLeg-<?php echo $eventId;?>" type="text" value="<?php echo $numberOfStepsPerLeg;?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_restDuration-<?php echo $eventId;?>" type="text" value="<?php echo $restDuration;?>" class="x-form-text x-form-field" style="width:80%;">
                    <div class="newdbsub">
    ...
    case ActiveTask::TWOFINGERTAPPINGINTERVAL:
        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_duration-<?php echo $eventId;?>" type="text" value="<?php echo $duration; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <div>
                        <input type="radio" name="extendedConfig_handOptions-<?php echo $eventId;?>" <?php echo $bothChecked;?> id="both-<?php echo $eventId;?>" value="<?php echo ActiveTasks\TwoFingerTappingInterval::HANDOPTIONS_BOTH; ?>">
                        <label for="both-<?php echo $eventId;?>"><?php print RCView::tt('global_74');?></label>
                    </div>
                    <div>
                        <input type="radio" name="extendedConfig_handOptions-<?php echo $eventId;?>" <?php echo $leftChecked;?> id="left-<?php echo $eventId;?>" value="<?php echo ActiveTasks\TwoFingerTappingInterval::HANDOPTIONS_LEFT; ?>">
                        <label for="left-<?php echo $eventId;?>"><?php print RCView::tt('mycap_mobile_app_200');?></label>
                    </div>
                    <div style="margin:4px 0;">
                        <input type="radio" name="extendedConfig_handOptions-<?php echo $eventId;?>" <?php echo $rightChecked;?> id="right-<?php echo $eventId;?>" value="<?php echo ActiveTasks\TwoFingerTappingInterval::HANDOPTIONS_RIGHT; ?>">
                        <label for="right-<?php echo $eventId;?>"><?php print RCView::tt('mycap_mobile_app_201');?></label>
                    </div>
        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_walkDuration-<?php echo $eventId;?>" type="text" value="<?php echo $walkDuration; ?>" class="x-form-text x-form-field" style="width:80%;">
                    <div class="newdbsub">
        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_distanceInMeters-<?php echo $eventId;?>" type="text" value="<?php echo $distanceInMeters; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_timeLimit-<?php echo $eventId;?>" type="text" value="<?php echo $timeLimit; ?>" class="x-form-text x-form-field" style="width:80%;">
        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_initialSpan-<?php echo $eventId;?>" type="text" value="<?php echo $initialSpan; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_minimumSpan-<?php echo $eventId;?>" type="text" value="<?php echo $minimumSpan; ?>" class="x-form-text x-form-field" style="width:80%;">
                    <div class="newdbsub">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_maximumSpan-<?php echo $eventId;?>" type="text" value="<?php echo $maximumSpan; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_playSpeed-<?php echo $eventId;?>" type="text" value="<?php echo $playSpeed; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_maxTests-<?php echo $eventId;?>" type="text" value="<?php echo $maxTests; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_maxConsecutiveFailures-<?php echo $eventId;?>" type="text" value="<?php echo $maxConsecutiveFailures; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <?php
                $yesChecked = ($requireReversal == 1) ? 'checked="checked"' : '';
                $noChecked = ($requireReversal == 0) ? 'checked="checked"' : '';
            ?>
            <tr>
                <td valign="top" style="font-weight:bold;">
                    <?php print RCView::tt('mycap_mobile_app_236');?>
                    <div class="newdbsub" style="font-weight: normal;">
                        <?php print RCView::tt('mycap_mobile_app_237');?>
                    </div>
                </td>
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <div>
                        <input type="radio" name="extendedConfig_requireReversal-<?php echo $eventId;?>" <?php echo $yesChecked;?> id="yes-<?php echo $eventId;?>" value="1">
                        <label for="yes-<?php echo $eventId;?>"><?php print RCView::tt('design_100')?></label>
                    </div>
                    <div>
                        <input type="radio" name="extendedConfig_requireReversal-<?php echo $eventId;?>" <?php echo $noChecked;?> id="no-<?php echo $eventId;?>" value="0">
                        <label for="no-<?php echo $eventId;?>"><?php print RCView::tt('design_99')?></label>
                    </div>
                </td>
            </tr>
        </table>
        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_numberOfAttempts-<?php echo $eventId;?>" type="text" value="<?php echo $numberOfAttempts; ?>" class="x-form-text x-form-field" style="width:80%;">
        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_trailMakingInstruction-<?php echo $eventId;?>" type="text" value="<?php echo $trailMakingInstruction; ?>" class="x-form-text x-form-field" style="width:80%;">
                    <div class="newdbsub">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <div>
                        <input type="radio" name="extendedConfig_trailType-<?php echo $eventId;?>" <?php echo $aChecked;?> id="a-<?php echo $eventId;?>" value="<?php echo ActiveTasks\TrailMaking::TYPE_A;?>">
                        <label for="a-<?php echo $eventId;?>"><?php print RCView::tt('mycap_mobile_app_245'); ?></label>
                    </div>
                    <div>
                        <input type="radio" name="extendedConfig_trailType-<?php echo $eventId;?>" <?php echo $bChecked;?> id="b-<?php echo $eventId;?>" value="<?php echo ActiveTasks\TrailMaking::TYPE_B;?>">
                        <label for="b-<?php echo $eventId;?>"><?php print RCView::tt('mycap_mobile_app_246'); ?></label>
                    </div>
                </td>
            </tr>
        </table>
        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <div>
                        <input type="radio" name="extendedConfig_presentationMode-<?php echo $eventId;?>" <?php echo $avChecked;?> id="av-<?php echo $eventId;?>" value="<?php echo ActiveTasks\PSAT::MODE_AUDITORYANDVISUAL; ?>">
                        <label for="av-<?php echo $eventId;?>"><?php print RCView::tt('mycap_mobile_app_249'); ?></label>
                    </div>
                    <div>
                        <input type="radio" name="extendedConfig_presentationMode-<?php echo $eventId;?>" <?php echo $aChecked;?> id="a-<?php echo $eventId;?>" value="<?php echo ActiveTasks\PSAT::MODE_AUDITORY; ?>">
                        <label for="a-<?php echo $eventId;?>"><?php print RCView::tt('mycap_mobile_app_250'); ?></label>
                    </div>
                    <div>
                        <input type="radio" name="extendedConfig_presentationMode-<?php echo $eventId;?>" <?php echo $vChecked;?> id="v-<?php echo $eventId;?>" value="<?php echo ActiveTasks\PSAT::MODE_VISUAL; ?>">
                        <label for="v-<?php echo $eventId;?>"><?php print RCView::tt('mycap_mobile_app_251'); ?></label>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_interStimulusInterval-<?php echo $eventId;?>" type="text" value="<?php echo $interStimulusInterval; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_stimulusDuration-<?php echo $eventId;?>" type="text" value="<?php echo $stimulusDuration; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_seriesLength-<?php echo $eventId;?>" type="text" value="<?php echo $seriesLength; ?>" class="x-form-text x-form-field" style="width:80%;">
        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_numberOfDisks-<?php echo $eventId;?>" type="text" value="<?php echo $numberOfDisks; ?>" class="x-form-text x-form-field" style="width:80%;">
        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_maximumStimulusInterval-<?php echo $eventId;?>" type="text" value="<?php echo $maximumStimulusInterval; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_minimumStimulusInterval-<?php echo $eventId;?>" type="text" value="<?php echo $minimumStimulusInterval; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_thresholdAcceleration-<?php echo $eventId;?>" type="text" value="<?php echo $thresholdAcceleration; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_timeout-<?php echo $eventId;?>" type="text" value="<?php echo $timeout; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_successSound-<?php echo $eventId;?>" type="text" value="<?php echo $successSound; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_timeoutSound-<?php echo $eventId;?>" type="text" value="<?php echo $timeoutSound; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_failureSound-<?php echo $eventId;?>" type="text" value="<?php echo $failureSound; ?>" class="x-form-text x-form-field" style="width:80%;">
        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_speechInstruction-<?php echo $eventId;?>" type="text" value="<?php echo $speechInstruction; ?>" class="x-form-text x-form-field" style="width:80%;">
                    <div class="newdbsub">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_shortSpeechInstruction-<?php echo $eventId;?>" type="text" value="<?php echo $shortSpeechInstruction; ?>" class="x-form-text x-form-field" style="width:80%;">
                    <div class="newdbsub">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <div>
                        <input type="radio" name="extendedConfig_checkAudioLevel-<?php echo $eventId;?>" <?php echo $yesChecked;?> id="yes-<?php echo $eventId;?>" value="1">
                        <label for="yes-<?php echo $eventId;?>"><?php print RCView::tt('design_100');?></label>
                    </div>
                    <div>
                        <input type="radio" name="extendedConfig_checkAudioLevel-<?php echo $eventId;?>" <?php echo $noChecked;?> id="no-<?php echo $eventId;?>" value="0">
                        <label for="no-<?php echo $eventId;?>"><?php print RCView::tt('design_99');?></label>
                    </div>
                </td>
            </tr>
        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_infoTitle-<?php echo $eventId;?>" type="text" value="<?php echo $infoTitle; ?>" class="x-form-text x-form-field" style="width:80%;">
                </td>
            </tr>
            <tr>
                <td valign="top" style="font-weight:bold;">
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <textarea name="extendedConfig_infoInstructions-<?php echo $eventId;?>" class="x-form-field notesbox" style="width:90%;margin-bottom:3px;vertical-align: top;"><?php echo $infoInstructions; ?></textarea>
                </td>
            </tr>
            <tr>
                <td valign="top" style="font-weight:bold;">
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_captureTitle-<?php echo $eventId;?>" type="text" value="<?php echo $captureTitle; ?>" class="x-form-text x-form-field" style="width:80%;">
                    <div class="newdbsub">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <textarea name="extendedConfig_captureInstructions-<?php echo $eventId;?>" class="x-form-field notesbox" style="width:90%;margin-bottom:3px;vertical-align: top;"><?php echo $captureInstructions; ?></textarea>
                    <div class="newdbsub">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_waitTime-<?php echo $eventId;?>" type="text" value="<?php echo $waitTime; ?>" class="x-form-text x-form-field" style="width:80%;">
        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <select name="extendedConfig_speechRecognizerLocale-<?php echo $eventId;?>" class="x-form-text x-form-field fs14" style="max-width:400px;">
                        <?php
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_speechRecognitionText-<?php echo $eventId;?>" type="text" value="<?php echo $speechRecognitionText; ?>" class="x-form-text x-form-field" style="width:80%;">
                    <div class="newdbsub">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <div>
                        <input type="radio" name="extendedConfig_shouldHideTranscript-<?php echo $eventId;?>" <?php echo $yesChecked;?> id="yes-<?php echo $eventId;?>" value="1">
                        <label for="yes-<?php echo $eventId;?>"><?php print RCView::tt('design_100')?></label>
                    </div>
                    <div>
                        <input type="radio" name="extendedConfig_shouldHideTranscript-<?php echo $eventId;?>" <?php echo $noChecked;?> id="no-<?php echo $eventId;?>" value="0">
                        <label for="no-<?php echo $eventId;?>"><?php print RCView::tt('design_99')?></label>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <div>
                        <input type="radio" name="extendedConfig_allowsEdittingTranscript-<?php echo $eventId;?>" <?php echo $yesChecked;?> id="yes-<?php echo $eventId;?>" value="1">
                        <label for="yes-<?php echo $eventId;?>"><?php print RCView::tt('design_100')?></label>
                    </div>
                    <div>
                        <input type="radio" name="extendedConfig_allowsEdittingTranscript-<?php echo $eventId;?>" <?php echo $noChecked;?> id="no-<?php echo $eventId;?>" value="0">
                        <label for="no-<?php echo $eventId;?>"><?php print RCView::tt('design_99')?></label>
                    </div>
                </td>
            </tr>
        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_toneDuration-<?php echo $eventId;?>" type="text" value="<?php echo $toneDuration; ?>" class="x-form-text x-form-field" style="width:80%;">
        ...
        <table cellspacing="3" style="width:100%; font-size: 13px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <div>
                        <input type="radio" name="extendedConfig_dominantHand-<?php echo $eventId;?>" <?php echo $leftChecked;?> id="left-<?php echo $eventId;?>" value="<?php echo ActiveTasks\HolePeg::HAND_LEFT; ?>">
                        <label for="left-<?php echo $eventId;?>"><?php print RCView::tt('mycap_mobile_app_200');?></label>
                    </div>
                    <div style="margin:4px 0;">
                        <input type="radio" name="extendedConfig_dominantHand-<?php echo $eventId;?>" <?php echo $rightChecked;?> id="right-<?php echo $eventId;?>" value="<?php echo ActiveTasks\HolePeg::HAND_RIGHT; ?>">
                        <label for="right-<?php echo $eventId;?>"><?php print RCView::tt('mycap_mobile_app_201');?></label>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_numberOfPegs-<?php echo $eventId;?>" type="text" value="<?php echo $numberOfPegs; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <input name="extendedConfig_threshold-<?php echo $eventId;?>" type="text" value="<?php echo $threshold; ?>" class="x-form-text x-form-field" style="width:80%;">
            ...
            <tr>
                ...
                <td valign="top" style="padding-left:15px;padding-bottom:5px;">
                    <div>
                        <input type="radio" name="extendedConfig_rotated-<?php echo $eventId;?>" <?php echo $yesChecked;?> id="yes-<?php echo $eventId;?>" value="1">
                        <label for="yes-<?php echo $eventId;?>"><?php print RCView::tt('design_100')?></label>
                    </div>
                    <div>
                        <input type="radio" name="extendedConfig_rotated-<?php echo $eventId;?>" <?php echo $noChecked;?> id="no-<?php echo $eventId;?>" value="0">
                        <label for="no-<?php echo $eventId;?>"><?php print RCView::tt('design_99')?></label>
                    </div>
                </td>
            </tr>
