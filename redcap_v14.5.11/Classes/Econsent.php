...
class Econsent
{
    ...
    public function renderTabs()
    {
        ...
        $tabs = [];
        $tabs['Design/online_designer.php'] = RCView::span(['class'=>'text-secondary fs12'], RCView::fa('fa-solid fa-circle-chevron-left mr-1 fs14') . RCView::tt('econsent_07'));
        if ($pdf_econsent_system_enabled) $tabs['index.php?route=EconsentController:index'.$get] = RCView::fa('fa-solid fa-user-pen mr-1 fs14') . RCView::tt('econsent_29');
        $tabs['index.php?route=PdfSnapshotController:index'] = RCView::fa('fa-solid fa-camera fs15 mr-1') . RCView::tt('econsent_30');
    ...
    public static function uploadConsentForm($consent_id, $consent_form_id)
    {
        global $lang;
    ...
    public function addConsentForm($consent_id)
    {
        ...
        $tab1 = RCView::div(array('class'=>'mt-2 mb-3'),
            ...
            RCView::div(array('class'=>'mb-2 mx-2'),
                RCView::tt('econsent_88') . " " . RCView::tt('econsent_186')
            ) .
...
EOF;
    ...
    public static function getEconsentSettings($project_id)
    {
    ...
    public static function getEconsentOptionsData($project_id, $record, $form, $dag_id=null, $lang_id=null)
    {
        $Proj = new Project($project_id);
    ...
    public function getCustomEconsentLabel($project_id, $record, $event_id, $form, $instance, $consent_id)
    {
        $Proj = new Project($project_id);
        $custom_econsent_label = $this->getAllEconsents($project_id)[$consent_id]['custom_econsent_label'] ?? '';
        return trim(Piping::replaceVariablesInLabel($custom_econsent_label, $record, $event_id, $instance, [], false, $project_id, false, ($Proj->isRepeatingForm($event_id, $form) ? $form : ""), 1, false, false, $form));
    }
