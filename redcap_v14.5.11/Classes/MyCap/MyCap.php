...
class MyCap
{
    ...
    public function loadMyCapProjectValues()
    {
        ...
        while ($row = db_fetch_assoc($q))
        {
            ...
            $this->tasks[$row['form_name']]['schedule_details'] = Task::displayTaskSchedule($row['task_id']);
    ...
    public function generateProjectConfigJSON($projectId = null, $publishedFrom = 'all') {
            ...
            foreach ($tasks as $taskId => $task) {
                ...
                if (!empty($taskSchedules)) {
                    ...
                    if ($Proj->longitudinal) {
                        if (count($taskSchedules) > 0) {
                            foreach ($taskSchedules as $eventId => $schedule) {
                                ...
                                $tasksData[$i]['longitudinalSchedule'][] = array('identifier' => (string) $eventId,
                                    ...
                                    'extendedConfigJson' => (!is_null($schedule['extended_config_json'])) ? $schedule['extended_config_json'] : "",
                                    'frequency' => $frequency,
                        ...
                        $tasksData[$i]['extendedConfigJson'] = (!is_null($schedule['extended_config_json'])) ? $schedule['extended_config_json'] : "";
                        if ($schedule['include_instruction_step'] == 1) {
        ...
        $projectConfigArr['languages'] = MultiLanguage::getMyCapActiveLanguages(PROJECT_ID);
    ...
    public function renderTabs() {
        ...
        $tabs["participants"] = array("fa"=>"fas fa-users", "label"=>$lang['mycap_mobile_app_01']);
        ...
        $tabs["help"] = array("fa"=>"fas fa-circle-question", "label"=>"Help");
    ...
    public static function displayCustomSetupTable()
    {
        ...
        <form id="customSettingsForm">
            <div>
                <div class="mb-3 fs13" style="line-height: 1.4;"><?php echo RCView::tt('mycap_mobile_app_848') ?></div>
                        ...
                        <tr>
                            <td colspan="2" valign="top" style="margin-left:1.5em;text-indent:-2.2em;padding:0px 5px 10px 40px;">
                                <div style="margin:5px; padding-top: 10px; font-weight: bold;">
                                    ...
                                    <b style=""><u><?php echo RCView::tt('mycap_mobile_app_849') ?></u></b>
                                </div>
                                <div style="text-indent:0em; padding-top: 5px;">
                                    <div>
     ...
     * @return bool
     */
    public function updateMLMConfigJSON () {
