...
function loginFunctionLdap($username = null, $status = null, &$auth = null)
{
	echo   "<p>
				...
				<a target='_blank' href='https://community.projectredcap.org/post.php?id=695' style='text-decoration:underline;'>LDAP setup page</a> on the REDCap Community website.
			</p>";
