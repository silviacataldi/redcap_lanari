...
function setMosioDisplayInfo() {
	if ($('select[name="mosio_enabled_by_super_users_only"]').val() == '0') {
...
<tr  id="enable_url_shortener-tr" sq_id="enable_url_shortener">
	...
	<td class="cc_data">
		...
		<div class="cc_info">
			<?php echo $GLOBALS['enable_url_shortener_redcap'] ? $lang['system_config_703'] : $lang['system_config_702'] ?>
		</div>
	</td>
</tr>
...
<tr>
    <td class="cc_label">
        <div class="hang">
            <img src="<?=APP_PATH_IMAGES?>tick_shield.png" style="position:relative;top:-2px;">
            <?php echo $lang['global_34'] ?>
        </div>
        <div class="cc_info">
...
<tr>
    <td colspan="2">
    <h4 style="font-size:13px;padding:10px 10px 0;color:#B00000;border-top:1px dashed #ddd;">
