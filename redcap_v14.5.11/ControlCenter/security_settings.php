...
<tr  id="auth_meth_global-tr" sq_id="auth_meth_global">
	...
	<td class="cc_data">
		...
		<div class="cc_info" style="font-weight:normal;">
			...
			<a href="https://community.projectredcap.org/post.php?id=691" target="_blank" style="text-decoration:underline;"><?php echo $lang['system_config_223'] ?></a><?php echo $lang['system_config_224'] ?>
		</div>
...
<tr>
	...
	<td class="cc_data" style="padding-top:20px;">
		...
		<div style="color: #777;"><?php echo $lang['system_config_462'] .
...
<tr>
	...
	<td class="cc_data" style="padding-bottom:0;">
		...
		<div style="margin-top:15px;">
			...
			<div class="fs11"><?php echo $lang['system_config_893'] ?> <code class="fs12">1.2.3.*, 1.2.3.0-1.2.3.255, 21DA:00D3:0000:2F3B::/64</code></div>
        </div>
	</td>
</tr>
...
<tr>
    ...
    <td class="cc_data">
        ...
        <div class="cc_info">
            <?php echo $lang['system_config_700'] ?><br><code class="fs12">!@#$%^&*()/_+|~=’,-*+:\";?.</code> (excluding <code class="fs12">><\</code> )
        </div>
    </td>
</tr>
    ...
    <td colspan="2">
        ...
        <div class="cc_info" style="margin: 5px 10px;">
            <?php echo $lang['system_config_755'] .
                "<div class='mt-2 fs13'>REDIRECT_URL = <code class='fs13'>".APP_PATH_WEBROOT_FULL."index.php</code>
                 <br>POST_LOGOUT_REDIRECT_URI = <code class='fs13'>".APP_PATH_WEBROOT_FULL."index.php?logout=1</code></div>" ?>
        </div>
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td class="cc_data">
        ...
        <div class="cc_info">
            <?php echo $lang['system_config_754'] ?>
        </div>
    </td>
</tr>
<tr>
...
<tr>
    <td class="cc_label"><?php echo $lang['system_config_788'] ?></td>
    <td class="cc_data">
...
<tr  id="aafScopeTarget-tr" sq_id="aafScopeTarget">
        ...
        <td class="cc_data">
		 ...
		 <textarea class='x-form-field notesbox' style='margin-top:3px;height:80px;' name='aafScopeTarget' ><?php echo htmlspecialchars($element_data['aafScopeTarget'], ENT_QUOTES) ?></textarea><br/>
                <div class="cc_info">
                        <?php echo $lang['system_config_837'] ?>
                </div>
        </td>
</tr>
<tr>
