...
if (!System::isCI()) {
    ...
    if (!is_dir(dirname(APP_PATH_DOCROOT) . "/languages")) {
        $testInitMsg .= "<br> &bull; languages - <b>".$lang['check_032']."</b> - ".$lang['check_038']." 3.2.0.
			See the <a href='https://community.projectredcap.org/custom/download.php' style='text-decoration:underline;' target='_blank'>".$lang['check_039']."</a>.
...
if (isDirWritable($temp_dir)) {
	print "<div class='darkgreen'><img src='".APP_PATH_IMAGES."tick.png'> <b style='color:green;'>".$lang['check_122']." $temp_dir</b></div>";
} else {
...
if ($fixStructure || $fixData) {
    print "<div class='yellow'><img src='" . APP_PATH_IMAGES . "exclamation_orange.png'> ".$lang['check_155']."
            <div class='mt-2'><a href='fixdb.php' style='text-decoration:underline;'>".$lang['check_156']."</a></div>
            </div>";
}
...
if (!function_exists('gzuncompress')) {
	print "<div class='red'>
            <img src='".APP_PATH_IMAGES."exclamation.png'>".$lang['check_157']."</div>";
}
