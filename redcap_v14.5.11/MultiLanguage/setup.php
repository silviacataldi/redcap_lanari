...
$userid = USERID;
$allowedLangsHTML = MultiLanguage::getMyCapAppLanguageList();
    ...
    <template data-mlm-template="languages-row">
        <tr data-mlm-language="">
            ...
            <td>
                ...
                <button data-mlm-action="empty-pdf-all" class="btn btn-light btn-sm">
    ...
    <div class="d-none"><!-- Templates -->
        ...
        <template data-mlm-template="forms-row">
            <tr data-mlm-form="" data-mlm-language="">
                ...
                <td class="text-center">
                    <button data-mlm-action="export-single-form" class="btn btn-light btn-xs text-primary hide-when-ref-lang">
        ...
        <template data-mlm-template="field-jumplist">
            <div class="mlm-field-jumplist">
                <div class="mlm-search-tool">
                    ...
                    <input class="form-check-input" type="checkbox" data-mlm-action="toggle-hide-fielditems-translated" name="ui-hide-translated" id="ui-hide-translated">
                    <label for="ui-hide-translated" class="ms-1">
...
<div data-mlm-tab="mycap" class="d-none">
    ...
    <!-- Content -->
    <p class="mlm-reflang-notice yellow mt-3"><?=RCView::tt("multilang_751") // <b>This is the reference language.</b> There are no items on this tab that can be edited for the references language.<br><i>Please choose another language.</i> ?></p>
            ...
            <div data-mlm-mycap-app_title-items class="">
                ...
                <div data-mlm-mycap-setting="mycap-baseline_task" class="mlm-field-block">
                    <div class="form-group">
                        ...
                        <input type="text" data-mlm-translation data-mlm-type="mycap-baseline_task" data-mlm-name="<?=$this_key?>" data-mlm-index="" data-mlm-refhash="<?=$this_item["refHash"]?>" class="form-control form-control-sm mlm-textarea" id="<?=$this_key?>" placeholder="<?=RCView::tt_attr("multilang_89") // Enter translation ?>">
                    </div>
                </div>
                <?php endforeach; ?>
                <?php endif; ?>
...
<div data-mlm-tab="misc" class="d-none">
    ...
    <!-- Content -->
    <p class="mlm-reflang-notice yellow mt-3"><?=RCView::tt("multilang_712") // <b>This is the reference language.</b> There are no items on this tab that can be edited for the references language.<br><i>Please choose another language.</i> ?></p>
...
<div data-mlm-tab="ui" class="d-none">
    ...
    <div class="mlm-search-tool hide-when-subscribed">
        ...
        <div>
            ...
            <label for="ui-hide-translated" class="form-check-label">
                <?=RCView::tt("multilang_51") // Hide translated items ?> 
            </label>
        </div>
    </div>
            ...
            <div class="modal-body" data-mlm-modal-mode="add-info">
                <div>
                    ...
                    <div class="mlm-input-description" id="mlm-add-language-modal-key-desc" class="form-text text-muted">
                        ...
                        <?php } ?>
                        <span id="mcapp-langs-list" style="display: none;"><?php print $allowedLangsHTML; ?></span>
                    </div>
                </div>
                <div class="mt-3">
                    <label for="mlm-add-language-modal-display" class="fw-bold text-dangerrc">
                        <?=RCView::tt("multilang_206") // Display Name ?>
                    </label>
        ...
        <div class="modal-content" data-mlm-mode="<?=$is_project ? "project" : "system"?>">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <div class="mlm-input-description" id="mlm-edit-language-modal-key-desc" class="form-text text-muted">
                        ...
                        <?php } ?>
                        <span id="mcapp-langs-list-edit" style="display: none;"><?php print $allowedLangsHTML; ?></span>
                    </div>
                </div>
                <div class="mt-3">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-sm btn-primary" data-mlm-modal-btn="save">
                    ...
                    <?=RCView::tt("control_center_4876") // Save Changes ?>
                </button>
            </div>
            <!-- #endregion -->
        </div>
...
print "<script>window.REDCap.MultiLanguage.init($init_json);</script>";
